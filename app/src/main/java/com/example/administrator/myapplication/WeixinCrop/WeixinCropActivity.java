package com.example.administrator.myapplication.WeixinCrop;
...
import com.example.administrator.myapplication.WeixinCrop.crop.Const;
import com.example.administrator.myapplication.WeixinCrop.crop.IOUtils;
import com.example.administrator.myapplication.WeixinCrop.crop.PhotoActionHelper;
...
public class WeixinCropActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crop_weixin);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_crop_weixin, menu);
        return true;
    }
